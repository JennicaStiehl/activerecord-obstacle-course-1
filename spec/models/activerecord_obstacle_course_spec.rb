...
# ----------------------
  ...
  it '12. should return all items except items 2, 5 and 6' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    # Solution goes here
    # items = Item.where.not(id: [2,5,6]).order(:created_at).take(7)
...
# ========================
  ...
  it '18. returns the names of items for a users order' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    # Solution goes here
    expected_result = Item.joins(:orders).where({orders:{user_id:2,id:3}}).order(:created_at).distinct.pluck(:name)
...
# ========================
  ...
  it '24. returns all orders for user 2 which include item_4' do
    ...
    #  Solution goes here
    # binding.pry
    orders = Order.joins(:items).where(items: { id: @item_4 }, user: @user_2 )
    # -----------------------------------------------------------
  ...
  it '25. returns items that are associated with one or more orders' do
    ...
    # Solution goes here
    ordered_items = Item.joins(:order_items).group(:item_id)
    #OrderItem.joins(:items).distinct
    # binding.pry
    ...
    #                     .distinct
    #                     .pluck(:name)
                        # .select("count(orders.id)as num_orders")
                        # .group("orders.id")
...
# ========================
  ...
  it '26. returns the names of items that are associated with one or more orders' do
    ...
    # ------------------ ActiveRecord Solution ----------------------
    # Solution goes here
    ordered_items_names = Item.joins(:order_items).group(:item_id).order('items.id').pluck(:name)
  ...
  it '28. returns a table of information for all users items' do
    ...
    # ------------------ ActiveRecord Solution ----------------------
    # binding.pry
    custom_results =Order.joins(:items, :user)
  ...
  it '29. returns a table of information for all users orders and item counts' do
    ...
    data = User.joins(orders: :order_items)
                ...
                .order('users.name DESC, order_id ASC')
    # ---------------------------------------------------------------
